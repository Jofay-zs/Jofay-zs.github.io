...
const Home = () => {
  return (
    <section className="flex w-full h-screen items-center justify-center" id="home">
      <StaticImage
        className="absolute top-0 left-0 bg-cover z-10 h-full w-full"
      ...
      />
      <div className="absolute top-0 left-0 z-20 bg-gradient-to-r from-main via-gray-900/75 h-full w-full"></div>
